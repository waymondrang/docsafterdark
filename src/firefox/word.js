...
function set_up() {
  document.documentElement.style.setProperty(
    "--checkmark",
    "url(" + browser.runtime.getURL("assets/checkmark.secondary.png") + ")"
  );
  document.documentElement.style.setProperty(
    "--revisions-sprite1",
    "url(" +
      browser.runtime.getURL("assets/revisions_sprite1.secondary.svg") +
      ")"
  );
  document.documentElement.style.setProperty(
    "--close_18px",
    "url(" + browser.runtime.getURL("assets/close_18px.svg") + ")"
  );
  document.documentElement.style.setProperty(
    "--lens",
    "url(" + browser.runtime.getURL("assets/lens.svg") + ")"
  );
  document.documentElement.style.setProperty(
    "--jfk_sprite186",
    "url(" + browser.runtime.getURL("assets/jfk_sprite186.edited.png") + ")"
  );
  document.documentElement.style.setProperty(
    "--dimension_highlighted",
    "url(" +
      browser.runtime.getURL("assets/dimension-highlighted.edited.png") +
      ")"
  );
  document.documentElement.style.setProperty(
    "--dimension_unhighlighted",
    "url(" +
      browser.runtime.getURL("assets/dimension-unhighlighted.edited.png") +
      ")"
  );
  document.documentElement.style.setProperty(
    "--access_denied",
    "url(" + browser.runtime.getURL("assets/access_denied_transparent.png") + ")"
  );
  document.documentElement.style.setProperty(
    "--access_denied_600",
    "url(" +
      browser.runtime.getURL("assets/access_denied_600_transparent.png") +
      ")"
  );
  document.documentElement.style.setProperty(
    "--gm_add_black_24dp",
    "url(" + browser.runtime.getURL("assets/gm_add_black_24dp.png") + ")"
  );
    ...
    function (data) {
      ...
      if ((data.updates && !data.updates.includes(version)) || !data.updates) {
        ...
        if (data.updates) {
          ...
          browser.storage.local.set({ updates: data.updates });
        } else {
...
browser.storage.local.get(["on"], function (data) {
  ...
  if (data.on == null) {
    dad();
    browser.storage.local.set({ on: true }); // Enable by default
    dark_mode_state = true;
