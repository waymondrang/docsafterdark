...
const docsafterdark_version = browser.runtime.getManifest().version
...
function inject_css_file(file) {
  ...
  css.setAttribute("href", browser.runtime.getURL(css_path + file));
  css.id = file_id;
  css.rel = "stylesheet";
...
for (let [key, value] of Object.entries(replacements)) {
  document.documentElement.style.setProperty(key, "url(" + browser.runtime.getURL(value) + ")");
}
