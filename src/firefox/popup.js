...
document.querySelectorAll("#document_bg button").forEach(function (e) {
    e.addEventListener("click", function (e) {
        ...
        browser.storage.local.set({ "doc_bg": id, "invert": { invert: false, grayscale: false } });
    })
})
...
invert.addEventListener("click", function (e) {
    ...
    browser.storage.local.set({ "invert": { invert: e.target.checked, grayscale: e.target.checked } });
})

grayscale.addEventListener("click", function (e) {
    browser.storage.local.set({ "invert": { invert: invert.checked, grayscale: e.target.checked } });
})
...
try {
    browser.storage.local.get(["doc_bg", "custom_bg", "invert", "on", "raise_button", "show_border"], function (data) {
